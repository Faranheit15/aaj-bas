...
- [ADR-0007: Versioned on-device state](0007-versioned-on-device-state.md) — the first data the product persists to a reader's device; sets the version, migration, eviction, and never-clobber-a-newer-document rules that AB-203, AB-204, AB-205, and AB-206 all inherit.
